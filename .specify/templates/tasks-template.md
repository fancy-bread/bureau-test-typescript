...
- [ ] T010 [P] [US1] Contract test for [endpoint] in src/[name].contract.test.ts
- [ ] T011 [P] [US1] Integration test for [user journey] in src/[name].integration.test.ts
...
- [ ] T018 [P] [US2] Contract test for [endpoint] in src/[name].contract.test.ts
- [ ] T019 [P] [US2] Integration test for [user journey] in src/[name].integration.test.ts
...
- [ ] T024 [P] [US3] Contract test for [endpoint] in src/[name].contract.test.ts
- [ ] T025 [P] [US3] Integration test for [user journey] in src/[name].integration.test.ts
...
Task: "Contract test for [endpoint] in src/[name].contract.test.ts"
Task: "Integration test for [user journey] in src/[name].integration.test.ts"
